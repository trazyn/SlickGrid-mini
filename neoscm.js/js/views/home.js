...
require( [ "ui/Countdown" ], function() {

	var
	conatiner = $( "#container" ),
	logo = conatiner.find( "#logo" ),
	intro = conatiner.find( "#intro" ),
	avatars = conatiner.find( "#avatars" ),
	pages = conatiner.find( "ul.pages > li.page" );
	...
	$( "#clock" ).countdown( { date: "2015/02/18" } );
} );
